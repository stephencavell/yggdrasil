...
public class CutSceneManager : MonoBehaviour {
	...
	void  Start (){
		...
		if (characterFemale == false) {
			...
			cutScenes.Add(new CutSceneObject(lifthrasirObject.transform, "Player: Look, there’s Loki with Lif! I have to stop him and save her!"));
			cutScenes.Add(new CutSceneObject(lokiObject.transform, "Player: What is Loki doing now??"));
			cutScenes.Add(new CutSceneObject(roosterObject.transform, "Odin: Oh, no. He is waking up the rooster. Quick, we have to stop him!"));
			cutScenes.Add(new CutSceneObject(playerObject.transform, "Player: What does the rooster have to do with anything? I need to save Lif!"));
